...
function Util.CompleteDestroy()
    for i, v in ipairs(getconnections(game:GetService('UserInputService').InputBegan)) do
        ...
        if (f) then
            ...
            if (not scr:IsDescendantOf(game:GetService("CoreGui"))) then 
                v:Disable() 
            end
        end
    end
...
function Library.Init(options)
    ...
    if _G.Settings.Position == nil then
        ...
        save()
            ...
            Motherframe.BackgroundColor3 = Color3.fromRGB(25, 23, 36)
            ...
            Shadow.ImageColor3 = Color3.fromRGB(38, 35, 58)
            Shadow.ScaleType = Enum.ScaleType.Slice
            Shadow.SliceCenter = Rect.new(23, 23, 277, 277)

            Header.Name = "Header"
            Header.Parent = Motherframe
            Header.BackgroundColor3 = Color3.fromRGB(31, 29, 46)
            ...
            Cover.Name = "Cover"
            Cover.Parent = Header
            Cover.BackgroundColor3 = Color3.fromRGB(31, 29, 46)
            ...
            Title1.Text = 'Phantom<font color="rgb(255,255,255)">Hub</font>'
            Title1.TextColor3 = Color3.fromRGB(246, 193, 119)
            Title1.TextSize = 14.000
            Title1.Position = UDim2.new(0.033,0,0,0)
        Title1.RichText = true

            BorderFrame.Name = "BorderFrame"
            BorderFrame.Parent = Header
            BorderFrame.BackgroundColor3 = Color3.fromRGB(40, 36, 59)
            BorderFrame.BorderSizePixel = 0
            BorderFrame.Position = UDim2.new(0, 97, 0, 7)
            ...
            function Tabs:Tab(tabname)
                ...
                for i,v in next, TabContainer:GetChildren() do
                    if v:IsA('TextButton')  and v.Name ~= "1Tab" then
                            v.TextColor3 = Color3.fromRGB(110, 106, 134)
                    end
                end
                Tab.MouseButton1Click:Connect(function()
                    for i,v in next, TabContainer:GetChildren() do
                        if v:IsA('TextButton')  then
                           TweenService:Create(v,TweenInfo.new(.2),{ TextColor3 = Color3.fromRGB(110, 106, 134)}):Play()
                          end
                    end
                    TweenService:Create(Tab, TweenInfo.new(.2), { TextColor3 = Color3.fromRGB(224, 222, 244)}):Play()
                    for i,v in next, Pages:GetChildren() do
                        v.Visible = false 
                    end
                    Page.Visible = true 
                ...
                function Sections:Section(sectionname)
                    ...
                    lbl.TextColor3 = Color3.fromRGB(144,140,170)
                    lbl.TextSize = 12.000
                ...
                function Elements:NewButton(options)
                   ...
                   if not options then options = {} end 
                    ...
                    Btn.BackgroundColor3 = Color3.fromRGB(38,35,58)
                    ...
                    Shadow.Size = UDim2.new(1, 30, 1, 30)
                    Shadow.Image = "http://www.roblox.com/asset/?id=5554236805"
                    Shadow.ImageColor3 = Color3.fromRGB(31,29,46)
                    Shadow.ScaleType = Enum.ScaleType.Slice
                    Shadow.SliceCenter = Rect.new(23, 23, 277, 277)
                    ...
                    Sample.ImageColor3 = Color3.fromRGB(110,106,134)
                    ...
                    Btn.MouseEnter:Connect(function(x, y)
                        local goal = {}
                        goal.BackgroundColor3 = Color3.fromRGB(46, 41, 69)
                        TweenService:Create(Btn,TweenInfo.new(.25), goal):Play()
                    end)
                    Btn.MouseLeave:Connect(function(x, y)
                        local goal = {}
                        goal.BackgroundColor3 = Color3.fromRGB(38,35,58)
                        TweenService:Create(Btn,TweenInfo.new(.25), goal):Play()
                    end)
                ...
                TextboxContainer.BackgroundColor3 = Color3.fromRGB(38,35,58)
                ...
                TbBorder.BackgroundColor3 = Color3.fromRGB(47, 44, 70)
                ...
                Textbox.BackgroundColor3 = Color3.fromRGB(31, 29, 46)
                ...
                function Elements:NewToggle(options)
                    ...
                    ToggleContainer.BackgroundColor3 = Color3.fromRGB(38,35,58)
                    ...
                    ToggleBorder.BackgroundColor3 = Color3.fromRGB(47, 44, 70)
                    ...
                    ToggleBack.BackgroundColor3 = Color3.fromRGB(246, 193, 119)
                    ...
                    ImageLabel.ImageColor3 = Color3.fromRGB(31, 29, 46)
                    ...
                    TextButton.MouseButton1Click:Connect(function()
                        State = not State
                        local NewColour = State and Color3.fromRGB(246, 193, 119) or Color3.fromRGB(31, 29, 46)
                    ...
                    if default then
                        ...
                        ToggleBack.BackgroundColor3 = Color3.fromRGB(31, 29, 46)
                        pcall(callback, State)
                        end
                end
                ...
                DropdownContainer.BorderColor3 = Color3.fromRGB(38,35,58)
                ...
                Orientation.ImageColor3 = Color3.fromRGB(246, 193, 119)
                ...
                DropItem.BackgroundColor3 = Color3.fromRGB(33, 32, 46)
                ...
                DropItem.MouseEnter:Connect(function()
                    TweenService:Create(DropItem,TweenInfo.new(.25),{BackgroundColor3 = Color3.fromRGB(46, 41, 69)}):Play()
                end)
                DropItem.MouseLeave:Connect(function()
                    TweenService:Create(DropItem,TweenInfo.new(.25),{BackgroundColor3 = Color3.fromRGB(33, 32, 46)}):Play()
                end)
            ...
            function Elements:NewSlider(options)
                ...
                SliderContainer.BackgroundColor3 = Color3.fromRGB(38,35,58)
		...
		SliderTitle.Text = slidertitle
                ...
                SliderButton.BackgroundColor3 = Color3.fromRGB(31, 29, 46)
                ...
                SliderBack.BackgroundColor3 = Color3.fromRGB(246, 193, 119)
                SliderBack.BorderColor3 = Color3.fromRGB(38,35,58)
...
KeybindContainer.BackgroundColor3 = Color3.fromRGB(38,35,58)
...
KeybindBorder.BackgroundColor3 = Color3.fromRGB(47, 44, 70)
...
TextButton.BackgroundColor3 = Color3.fromRGB(31, 29, 46)
...
warn("xa1lt whats this like version 1000 ⚔")
return Library
